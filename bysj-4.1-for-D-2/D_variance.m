...
temp(1,1) = var(dlmread('C:\\d_2_c.txt',' '));
temp(2,1) = var(dlmread('C:\\d_2_ic.txt',' '));
temp(3,1) = var(dlmread('C:\\d_1_c.txt',' '));
temp(4,1) = var(dlmread('C:\\d_1_ic.txt',' '));
temp(5,1) = var(dlmread('C:\\d_20_c.txt',' '));
temp(6,1) = var(dlmread('C:\\d_20_ic.txt',' '));
temp(7,1) = var(dlmread('C:\\d_4_c.txt',' '));
temp(8,1) = var(dlmread('C:\\d_4_ic.txt',' '));
temp(9,1) = var(dlmread('C:\\d_6_c.txt',' '));
temp(10,1) = var(dlmread('C:\\d_6_ic.txt',' '));
temp(11,1) = var(dlmread('C:\\d_8_c.txt',' '));
temp(12,1) = var(dlmread('C:\\d_8_ic.txt',' '));
