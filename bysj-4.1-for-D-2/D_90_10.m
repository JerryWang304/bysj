...
temp(1,1) = prctile(dlmread('C:\\d_2_c.txt',' '),90) - prctile(dlmread('C:\\d_2_c.txt',' '),10);
temp(2,1) = prctile(dlmread('C:\\d_2_ic.txt',' '),90) - prctile(dlmread('C:\\d_2_ic.txt',' '),90);
temp(3,1) = prctile(dlmread('C:\\d_1_c.txt',' '),90) - prctile(dlmread('C:\\d_1_c.txt',' '),10);
temp(4,1) = prctile(dlmread('C:\\d_1_ic.txt',' '),90) - prctile(dlmread('C:\\d_1_ic.txt',' '),10);
temp(5,1) = prctile(dlmread('C:\\d_20_c.txt',' '),90) - prctile(dlmread('C:\\d_20_c.txt',' '),10);
temp(6,1) = prctile(dlmread('C:\\d_20_ic.txt',' '),90) - prctile(dlmread('C:\\d_20_ic.txt',' '),10);
temp(7,1) = prctile(dlmread('C:\\d_4_c.txt',' '),90) - prctile(dlmread('C:\\d_4_c.txt',' '),10);
temp(8,1) = prctile(dlmread('C:\\d_4_ic.txt',' '),90) - prctile(dlmread('C:\\d_4_ic.txt',' '),10);
temp(9,1) = prctile(dlmread('C:\\d_6_c.txt',' '),90) - prctile(dlmread('C:\\d_6_c.txt',' '),10);
temp(10,1) = prctile(dlmread('C:\\d_6_ic.txt',' '),90) - prctile(dlmread('C:\\d_6_ic.txt',' '),10);
temp(11,1) = prctile(dlmread('C:\\d_8_c.txt',' '),90) - prctile(dlmread('C:\\d_8_c.txt',' '),10);
temp(12,1) = prctile(dlmread('C:\\d_8_ic.txt',' '),90) - prctile(dlmread('C:\\d_8_ic.txt',' '),10);
...
ylabel('90 Percentile - 10 Percentile','FontSize', fs, 'FontName', 'Arial');
axis([0 5 0 60]);
